...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { height: @history.height, observation: @history.observation, pet_id: @history.pet_id, weight: @history.weight } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { height: @history.height, observation: @history.observation, pet_id: @history.pet_id, weight: @history.weight } }
